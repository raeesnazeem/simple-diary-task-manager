...
export default function BlockControls({ block, onUpdate }: BlockControlsProps) {
  ...
  return (
    <div className="absolute right-0 top-0 -mt-10 bg-white border border-gray-200 rounded-lg shadow-lg flex items-center p-1 gap-1 z-20 opacity-0 group-hover:opacity-100 transition-opacity focus-within:opacity-100 font-figtree">
